...
//   // 초기 파일 경로 확인 및 최적화 (Next.js 환경에 최적화)
//   const optimizeInitialPath = async () => {
//     const alternativePaths = [
//       '/contents/player/video/sample.mp4',  // Next.js 정적 파일 경로
//       '/contents/video/sample.mp4',         // 대체 경로
//       './video/sample.mp4',                 // 상대 경로
//       '../video/sample.mp4'                 // 상위 디렉토리
//     ];
...
//     console.log('Expected correct path: /contents/player/video/sample.mp4');
...
// // 경로 관리 유틸리티 (Next.js 환경에 최적화)
// const PathManager = {
//   // Next.js 환경에서 정적 파일 경로 가져오기
//   getBaseUrl: () => {
//     // Next.js에서는 /contents/player/ 경로로 접근
//     return '/contents';
//   },
...
//       // 현재 디렉토리 기준
//       const result = baseUrl + '/player' + relativePath.substring(1);
...
//   // 여러 경로 중 존재하는 파일 찾기 (Next.js 환경에 최적화)
//   findExistingFile: async (paths) => {
//     for (const path of paths) {
//       console.log(`Checking path: ${path}`);
      
//       // Next.js 환경에 맞는 절대 경로로 변환
//       let absolutePath;
//       if (path.startsWith('./')) {
//         // 현재 디렉토리 기준
//         absolutePath = '/contents/player' + path.substring(1);
//       } else if (path.startsWith('../')) {
//         // 상위 디렉토리로 이동
//         absolutePath = '/contents' + path.replace(/\.\.\//g, '');
//       } else if (path.startsWith('/')) {
//         // 절대 경로
//         absolutePath = path;
//       } else {
//         // 기본 경로
//         absolutePath = '/contents/player/' + path;
//       }
